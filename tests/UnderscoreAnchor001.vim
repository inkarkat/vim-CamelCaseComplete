...
call append(0, ['the testDelete_predefinedCxWithoutContentPackDevMode() function'])
...
call IsMatchesInIsolatedLine('tdpW', ['testDelete_predefinedCxWithoutContentPackDevMode'], 'single relaxed match with tdpW')
call IsMatchesInIsolatedLine('tdpC', ['testDelete_predefinedCxWithoutContentPackDevMode'], 'single relaxed match with tdpC')
call IsMatchesInIsolatedLine('tdcd', ['testDelete_predefinedCxWithoutContentPackDevMode'], 'single relaxed match with tdcd')
call IsMatchesInIsolatedLine('tddm', ['testDelete_predefinedCxWithoutContentPackDevMode'], 'single relaxed match with tddm')
