...
"call IsMatchesInIsolatedLine('sd',   ['single#sake_dross', 'single#lake_dros_repatable'], 'relaxed underscore matches with sd')
call IsMatchesInIsolatedLine('t#d',  ['tingle#sakeDrosss', 'tingle#lakeDrossRepeatable'], 'relaxed Camel matches with td')
...
"call IsMatchesInIsolatedLine('umc',  ['upeatable_mapping#take_cros', 'upeatable_mapping#make_cros_repatable'], 'relaxed underscore matches with umc')
